...
class EmployeeReviews < Minitest::Test
  ...
  def test_get_number_of_employees_in_department
    a = Department.new(name: "Marketing")
    assert_equal 0, a.total_employees
    xavier = Employee.new(first_name: "Xavier", last_name: "Donner", email: "ProfX@marvel.com", phone_number: "911", salary: 70000.00)
    new_employee = Employee.new(first_name: "Dan", last_name: "Doe", email: "d@mail.com", phone_number: "914-555-5555", salary: 50000.00)
    old_employee = Employee.new(first_name: "Yvonne", last_name: "Doe", email: "Yvonne@urFired.com", phone_number: "919-123-4567", salary: 40000.00)
    a.add_employee(xavier)
    a.add_employee(new_employee)
    a.add_employee(old_employee)
    assert_equal 3, a.total_employees
  end

  def test_get_lowest_paid_employee
    a = Department.new(name: "Marketing")
    xavier = Employee.new(first_name: "Xavier", last_name: "Donner", email: "ProfX@marvel.com", phone_number: "911", salary: 70000.00)
    new_employee = Employee.new(first_name: "Dan", last_name: "Doe", email: "d@mail.com", phone_number: "914-555-5555", salary: 50000.00)
    old_employee = Employee.new(first_name: "Yvonne", last_name: "Doe", email: "Yvonne@urFired.com", phone_number: "919-123-4567", salary: 40000.00)
    ...
    a.add_employee(new_employee)
    a.add_employee(old_employee)
    assert_equal old_employee, a.lowest_paid
  end

  def test_list_employees_by_name
    a = Department.new(name: "Marketing")
    xavier = Employee.new(first_name: "Xavier", last_name: "Donner", email: "ProfX@marvel.com", phone_number: "911", salary: 70000.00)
    new_employee = Employee.new(first_name: "Dan", last_name: "Doe", email: "d@mail.com", phone_number: "914-555-5555", salary: 50000.00)
    old_employee = Employee.new(first_name: "Yvonne", last_name: "Doe", email: "Yvonne@urFired.com", phone_number: "919-123-4567", salary: 40000.00)
    ...
    a.add_employee(new_employee)
    a.add_employee(old_employee)
    assert_equal [new_employee, xavier, old_employee], a.list_employees_by_name
  end

  def test_get_employees_paid_more_than_average
    a = Department.new(name: "Marketing")
    xavier = Employee.new(first_name: "Xavier", last_name: "Donner", email: "ProfX@marvel.com", phone_number: "911", salary: 70000.00)
    new_employee = Employee.new(first_name: "Dan", last_name: "Doe", email: "d@mail.com", phone_number: "914-555-5555", salary: 50000.00)
    old_employee = Employee.new(first_name: "Yvonne", last_name: "Doe", email: "Yvonne@urFired.com", phone_number: "919-123-4567", salary: 40000.00)
    ...
    a.add_employee(new_employee)
    a.add_employee(old_employee)
    assert_equal [xavier], a.paid_above_average
  end

  def test_employee_names_as_palidromes
    a = Department.new(name: "Marketing")
    xavier = Employee.new(first_name: "Xavier", last_name: "Donner", email: "ProfX@marvel.com", phone_number: "911", salary: 70000.00)
    ...
    a.add_employee(new_employee)
    a.add_employee(old_employee)
    assert_equal [new_employee], a.employee_palindromes
  end
  ...
  def test_get_department_with_most_employees
    ...
    assert_equal a, b.largest_department
  end

  def test_move_all_employees
    a = Department.new(name: "Marketing")
    ...
    a.add_employee(old_employee)
    a.move_to(b)
    assert_equal [xavier,new_employee,old_employee], b.employees
  end

  def test_give_all_employees_in_department_raise_by_percent
    a = Department.create(name: "Marketing")
    xavier = Employee.create(first_name: "Xavier", last_name: "Donner", email: "ProfX@marvel.com", phone_number: "911", salary: 70000.00, performance: false)
    new_employee = Employee.create(first_name: "Race", last_name: "Car", email: "d@mail.com", phone_number: "914-555-5555", salary: 50000.00, performance: true)
    old_employee = Employee.create(first_name: "Yvonne", last_name: "Doe", email: "Yvonne@urFired.com", phone_number: "919-123-4567", salary: 40000.00, performance: true)
    a.add_employee(xavier)
    a.add_employee(new_employee)
    a.add_employee(old_employee)
    a.department_raise_by_percent(0.1) {|e| e.performance == true}
    assert_equal 70000.00, xavier.salary.to_f
    assert_equal 55000.00, new_employee.salary.to_f
    assert_equal 44000.00, old_employee.salary.to_f
  end
